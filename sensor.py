...
#
def send(json_document, mq_server, mq_server_port="5672"):
	...
	channel.basic_publish(exchange='', routing_key= 'queue', body= json_document)
	print(" [x] Sent " + json_document)
	connection.close()
#
...
#
def get_email_info(web_server, web_server_port="80"):
